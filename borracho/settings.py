"""
Django settings for borracho project.
...
ROOT_URLCONF = 'borracho.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, 'borracho-client/build')
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'borracho.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'borracho-client/build/static')
]
